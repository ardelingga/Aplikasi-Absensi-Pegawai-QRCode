...
//var_dump($donut_dep_data);
$donut_dep_view = implode(', ', $donut_dep_data);
//var_dump($donut_dep_view);
...
<div class="row">
	<div class="col-md-6">
		<div class="box box-primary">
			...
			<div class="box-body">
				<canvas id="donut_staff" style="height:250px"></canvas>
				<table class="table">
					<?php
					$total_staff = 0;
					$no = 0;
					foreach ($data_dept as $row) {
						...
						echo '<tr style="background-color: #'.$warna_arr[$no].'"><td>'.$row->nama_departemen.'</td><td>'.$row->jumlah.'</td></tr>';
						$total_staff += $row->jumlah;
						$no++;
					}
					echo '<tr style="background-color: #ddd;"><td><strong>Total</strong></td><td><strong>'.$total_staff.'</strong></td></tr>';
...
<script type="text/javascript">
    ...
    var pieChartCanvas = $("#donut_staff").get(0).getContext("2d");
    var pieChart = new Chart(pieChartCanvas);
    var PieData = [
    <?php echo $donut_dep_view; ?>
    ];
    var pieOptions = {
