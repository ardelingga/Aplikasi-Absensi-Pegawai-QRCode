...
$query = "SELECT * FROM `m_set_waktu` WHERE `id` = '".$id."' "; 
...
if(isset($_POST['submit'])) {
	...
	if(trim($_POST['jam_mulai_abs']) == '') {
		$form_error[] = 'jam mulai absen harus diisi';
	}
	...
	if(empty($form_error)) {
		...
		$where = array('id' => $id);
		$update = $db->ubah('m_set_waktu', $data, $where);
		if($update) {
			set_notif('ubah_ok', 1);
			redirect('?m=waktu');
		} else {
	...
	<div class="col-md-12">
		<div class="box box-success">
			<div class="box-header with-border">
				<h3 class="box-title">Ubah Data Waktu</h3>
			...
			<form method="POST">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<input type="text" placeholder="Masukkan Nama" id="nama_seting" name="nama_seting" value="<?php echo $row->nama_seting;?>" class="form-control">
					</div>
					...
					<div class="bootstrap-timepicker">
						<div class="form-group" style="width: 100px;">
							...
							<div class="input-group">
								<input type="text" name="jam_mulai_abs" value="<?php echo $row->jam_mulai_abs;?>" class="form-control timepicker">
					...
					<div class="bootstrap-timepicker">
						<div class="form-group" style="width: 100px;">
							...
							<div class="input-group">
								<input type="text" name="jam_masuk" value="<?php echo $row->jam_masuk;?>" class="form-control timepicker">
								<div class="input-group-addon">
									<i class="fa fa-clock-o"></i>
								</div>
							</div>
					...
					<div class="bootstrap-timepicker">
						<div class="form-group" style="width: 100px;">
							...
							<div class="input-group">
								<input type="text" name="jam_batas_masuk" value="<?php echo $row->jam_batas_masuk;?>" class="form-control timepicker">
								<div class="input-group-addon">
									<i class="fa fa-clock-o"></i>
								</div>
							</div>
					...
					<div class="bootstrap-timepicker">
						<div class="form-group" style="width: 100px;">
							...
							<div class="input-group">
								<input type="text" name="jam_pulang" value="<?php echo $row->jam_pulang;?>" class="form-control timepicker">
								<div class="input-group-addon">
									<i class="fa fa-clock-o"></i>
								</div>
							</div>
					...
					<div class="bootstrap-timepicker">
						<div class="form-group" style="width: 100px;">
							...
							<div class="input-group">
								<input type="text" name="jam_batas_pulang" value="<?php echo $row->jam_batas_pulang;?>" class="form-control timepicker">
								<div class="input-group-addon">
									<i class="fa fa-clock-o"></i>
								</div>
							</div>
